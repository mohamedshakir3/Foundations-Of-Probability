...
\begin{proof}
    ...
    This is because for a finite $a$, we have 
    \[\frac{X}{a} \geq 0 = I(X \geq a)\]
    when $X < a$, then 
    \[\frac{X}{a} \geq 1 = I(X \geq a)\]
    when $X \geq a$, so in either case $\frac{X}{a} \geq I(X \geq a)$. Then we can take expected value of each side of the inequality and get 
